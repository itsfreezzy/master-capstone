<div class="container">
    ...
    <form class="form-horizontal" action="{{ action('ReservationInfoController@store') }}" method="post" >
        @csrf
        {{--  Date Filed  --}}
        <div class="row">
                ...
                <div class="col-sm-10">
                    <select name="PrefFuncRooms[]" style="width: 93%" id="PrefFuncRoom" class="form-control form-horizontal" multiple required>
                        <optgroup label="Function Halls">   
                            ...
                            <option value="{{ $functionhall->code }}">{{ $functionhall->name }}</option>
                            @endforeach
                        </optgroup>
                        <optgroup label="Meeting Rooms">    
                            @foreach ($meetingrooms as $meetingroom)
                            <option data-id="{{ $meetingroom->timeblockcode }}" value="{{ $meetingroom->code }}">{{ $meetingroom->name }}</option>
                            @endforeach
                        </optgroup>
                    </select>
                </div>
        ...
        <div class="row">
            <div class="form-group">
                <label for="" class="control-label col-sm-2">Reservee Name:*</label>
                <div class="col-sm-4">
                    <input style="width:93%;" type="text" name="customername" id="" class="form-control form-horizontal" value="{{ old('customername') }}" required>
                </div>
                
                <label for="" class="control-label col-sm-2">TIN Number:*</label>
                <div class="col-sm-3">
                    <input  type="text" name="customertin" id="" class="form-control form-horizontal" value="{{ old('customertin') }}">
                </div>

                <div class="row">
                    <div class="col-sm-4 col-sm-offset-2 error">
                        @if ($errors->has('customername'))
                        <span style="color: red" role="alert">
                            <strong style="margin-left: 1%">{{ $errors->first('customername') }}</strong>
                        </span>
                        @endif
                    </div>
                @if ($errors->has('customertin'))
                    <div class="col-sm-offset-2 col-sm-4 error">
                        <span style="color: red" role="alert">
                            <strong>{{ $errors->first('customertin') }}</strong>
                        </span>
                    </div>
                @endif
                </div>
        ...
        {{-- Customer Type --}}
        <label class="radio-inline" style="padding-left: 18%; padding-top: 0%"><input checked type="radio" id="customertype" name="customertype" value="Company">Company</label>
        <label class="radio-inline" style="padding-top: 0%;"><input type="radio" id="customertype" name="customertype" value="Personal">Personal</label>

        {{-- Contact Number --}}
        <div class="row" style="padding-top: 1%">
            <div class="form-group">
                <label for="" class="control-label col-sm-2" >Contact Number:*</label>
                <div class="col-sm-10">
                    <input style="width:93%;" type="text" name="customercontactno" id="" class="form-control form-horizontal" value="{{ old('customercontactno') }}" required>
                </div>

                @if ($errors->has('customercontactno'))
                    <div class="col-sm-10 col-sm-offset-2 error">
                        <span style="color: red" role="alert">
                            <strong>{{ $errors->first('customercontactno') }}</strong>
                        </span>
                    </div>
                @endif
            </div>
        ...
        <div class="row" style="padding-top: 1%">
            <div class="form-group">
                <label for="" class="control-label col-sm-2">Email Address:*</label>
                <div class="col-sm-10">
                    <input style="width:93%;" type="text" name="customeremailadd" id="" class="form-control form-horizontal" value="{{ old('customeremailadd') }}" required>
                </div>

                @if ($errors->has('customeremailadd'))
                    <div class="col-sm-10 col-sm-offset-2 error">
                        <span style="color: red" role="alert">
                            <strong>{{ $errors->first('customeremailadd') }}</strong>
                        </span>
                    </div>
                @endif
            </div>
        ...
        <div class="row" style="padding-top: 1%">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input style="width:93%;" type="text" name="customerusername" id="" class="form-control form-horizontal" value="{{ old('customerusername') }}" required>
                </div>

                @if ($errors->has('customerusername'))
                    <div class="col-sm-10 col-sm-offset-2 error">
                        <span style="color: red" role="alert">
                            <strong>{{ $errors->first('customerusername') }}</strong>
                        </span>
                    </div>
                @endif
            </div>
        ...
        <div class="row" style="padding-top: 1%">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input style="width:93%;" type="password" name="customerpassword" id="" class="form-control form-horizontal" required>
                </div>

                @if ($errors->has('customerpassword'))
                    <div class="col-sm-10 col-sm-offset-2 error">
                        <span style="color: red" role="alert">
                            <strong>{{ $errors->first('customerpassword') }}</strong>
                        </span>
                    </div>
                @endif
            </div>
        ...
        <div class="row" style="padding-top: 1%">
            <div class="form-group">
                <label for="" class="control-label col-sm-2">Confirm Password:*</label>
                <div class="col-sm-10">
                    <input style="width:93%;" type="password" name="customerpassword_confirmation" id="" class="form-control form-horizontal" required>
                </div>
            </div>
        </div>
        @endif
