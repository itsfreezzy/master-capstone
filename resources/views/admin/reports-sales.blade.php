...
@section('content-header')
    <h1>
        Sales Report
        <small>Report about Sales</small>
    </h1>
    <ol class="breadcrumb">
	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				{{-- BUTTONS --}}
				<div class="col-xs-offset-3 row" style="padding-left: 0.5%; margin-top:0.5%">
	...
	$(function() {
		$('.submitbtn').on('click', function() {
			if ($(this).data('id') == 'search') {
				var route = "{{ route('admin.reports-sales.update') }}";
				$('#selectionform').attr('action', route);
				$('#selectionform').submit();
			} else if ($(this).data('id') == 'generate') {
				var route = "{{ route('admin.reports-sales.generatepdf') }}";
				$('#selectionform').attr('action', route);
				$('#selectionform').submit();
			}
		});
