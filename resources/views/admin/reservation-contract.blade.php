...
@section('content-header')
    <h1>
        ...
        <small>Release the reservation contract with or without comment/s.</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="/admin/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="/admin/reservations">Reservation</a></li>
        <li class="active">Release Reservation Contract</li>
    </ol>
@endsection
    ...
    <div class="col-md-offset-2 col-md-8">
        <div class="box box-primary">
            <div class="box-header" style="color: white; background-color: #3c8dbc">
                <h3 class="box-title">Reservation Contract</h3>
            ...
            <div class="box-body">
                ...
                <form action="{{ route('admin.submit.contract', ['id' => $reservation->id]) }}" method="POST" id="mainform">
                    @csrf
