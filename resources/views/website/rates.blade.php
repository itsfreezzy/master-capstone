...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="#fhalls-tab" data-toggle="tab">Function Halls</a></li>
        <li><a href="#mrooms-tab" data-toggle="tab">Meeting Rooms</a></li>
        <li><a href="#equipments-tab" data-toggle="tab">Equipments</a></li>
    </ul>
    <div class="tab-content">
        <div id="fhalls-tab" class="tab-pane fade in active">
        ...
        <div id="mrooms-tab" class="tab-pane fade in">
            <h3>Meeting Rooms</h3>
            <table id="tblMeetingRooms" class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ strpos($meetingroom->name, 'old') !== false ? explode(' ', $meetingroom->name)[0] : $meetingroom->name }}</td>
        ...
        <div id="equipments-tab" class="tab-pane fade in">
