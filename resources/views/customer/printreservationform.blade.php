        ...
        <form class="form-horizontal">
            ...
            <div class="row">
                <div class="form-group">
                    <label for="DateFiled" class="control-label col-xs-9">Date Filed:</label>
                    <div class="col-xs-2">
            ...
            <div class="row">
                <div class="form-group">
                    <label for="EventDate" class="control-label col-xs-2">Date of Event:*</label>
                    <div class="col-xs-10">
            ...
            <div class="row">
                <div class="form-group">
                    <label for="EventTitle" class="control-label col-xs-2">Title of Event:*</label>
                    <div class="col-xs-10">
            ...
            <div class="row">
                <div class="form-group">
                    <label for="PrefFuncRoom" class="control-label col-xs-2">Preferred Function Room/s:*</label>
                    <div class="col-xs-10">
            ...
            <div class="row">
                <div class="form-group">
                    <label for="Caterer" class="control-label col-xs-2">Caterer Name:*</label>
                    <div class="col-xs-10">
            ...
            <div class="row" style="padding-top: 2%">
                <div class="form-group">
                    <label for="EventNature" class="control-label col-xs-2">Nature of Event:*</label>
                    <div class="col-xs-9">
                        <select name="EventNature[]" id="EventNature" class="form-control form-horizontal" multiple disabled>
            ...
            <div class="row" style="padding-top: 1%">
                <div class="form-group">
                    {{--  <label for="EventTitle" class="control-label col-xs-2">Number of Attendees:*</label>  --}}
                    <p class="control-label col-xs-2">Number of Attendees:*</p>
                    <div class="col-xs-10">
            ...
            <div class="row">
                <div class="form-group">
                    {{--  <label for="EventTitle" class="control-label col-xs-2">Start Time:*</label>  --}}
                    <p class="control-label col-xs-2">Start Time:*</p>
                    <div class="col-xs-2">
                        <input style="" type="time" name="TimeStart" id="" class="form-control form-horizontal" value="{{ $reservationinfo->timestart }}" disabled>
                    </div>
    
    
                    {{--  <label for="EventTitle" class="control-label col-xs-2">End Time:*</label>  --}}
                    <p class="control-label col-xs-2">End Time:*</p>
                    <div class="col-xs-2">
            ...
            <div class="row">
                <div class="form-group">
                    {{--  <label for="EventTitle" class="control-label col-xs-2">Ingress Time:*</label>  --}}
                    <p class="control-label col-xs-2">Ingress Time:*</p>
                    <div class="col-xs-2">
                        <input style="" type="time" name="IngressTime" id="" class="form-control form-horizontal" value="{{ $reservationinfo->timeingress }}" disabled>
                    </div>
    
    
                    {{--  <label for="EventTitle" class="control-label col-xs-2">Eggress Time:*</label>  --}}
                    <p class="control-label col-xs-2">Eggress Time:*</p>
                    <div class="col-xs-2">
            ...
            <div class="row">
                <div class="form-group">
                    {{--  <label for="EventTitle" class="control-label col-xs-2">Ingress Date:</label>  --}}
                    <p class="control-label col-xs-2">Ingress Date:</p>
                    <div class="col-xs-2">
                        <input style="" type="date" name="IngressDate" id="" class="form-control form-horizontal" value="{{ $reservationinfo->dateingress }}" disabled>
                    </div>
    
    
                    {{--  <label for="EventTitle" class="control-label col-xs-2">Eggress Date:</label>  --}}
                    <p class="control-label col-xs-2">Eggress Date:</p>
                    <div class="col-xs-2">
            ...
            <div class="row">
                <div class="form-group">
                    <label for="SetupType" class="control-label col-xs-2">Physical Set-up:*</label>
                    <div class="col-xs-8">
                    ...
                    {{-- <button type="button" class="btn col-xs-1"> <i class="fa fa-plus"></i> Add</button> --}}
                </div>
            </div>
            ...
            <div class="row">
                <div id="listEquipment" class="form-group">
                    <div class="row">
                        <label id="lbl1" for="" class="col-xs-offset-1 col-xs-3 control-label">Equipment</label>
                        <label id="lbl2" for="" class="col-xs-offset-1 col-xs-1 control-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quantity</label>
                        <label id="lbl3" for="" class="col-xs-offset-1 col-xs-1 control-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Price</label>
                        <label class="col-xs-offset-2 col-xs-2" id="lbl4" style="visibility:hidden">asdzxcxzczxczcxzczxczxczxxczxczxczczxxczczczxcczxczcz</label>
                    </div>
                    ...
                    <div class="row">
                        <label class="col-xs-offset-6 col-xs-1 control-label">Total: P</label>
                        <div class="col-xs-2">
            ...
            <div class="row">
                <div class="form-group">
                    <label class="control-label col-xs-2">Event Organizer:*</label>
                    <div class="col-xs-10" >
            ...
            <div class="row" style="padding-top: 0">
                <div class="form-group">
                    <label class="control-label col-xs-2">Contact Persons: </label>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group">
                    <p class="control-label col-xs-2">Telephone Number:*</p>
                    <div class="col-xs-4">
            ...
            <div class="row">
                <div class="form-group">
                    <p class="control-label col-xs-2">Mobile Number:*</p>
                    <div class="col-xs-4">
            ...
            <div class="row" style="padding-bottom: 0%">
                <div class="form-group">
                    <p class="control-label col-xs-2">Home/Company Address:*</p>
                    <div class="col-xs-4">
