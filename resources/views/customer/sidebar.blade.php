    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li {{ (Request::is('customer') ? 'class=active' : '') }}>
                <a href="/customer/"><i class="fa fa-home"></i> <span>Home</span></a>
            </li>
            <li {{ (Request::is('customer/reservation', 'customer/reservation/*') ? 'class=active' : '') }}>
                <a href="/customer/reservation"><i class="fa fa-calendar"></i> <span>Reservations</span></a>
            </li>
            <li {{ (Request::is('customer/payments') ? 'class=active' : '') }}>
                <a href="/customer/payments"><i class="fa fa-money"></i> <span>Payments</span></a>
            </li>
            ...
            <li {{ (Request::is('customer/settings') ? 'class=active' : '') }}>
                <a href="/customer/settings"><i class="fa fa-gears"></i> <span>Settings</span></a>
            </li> --}}
            ...
            <li {{ (Request::is('admin/reports') ? 'class=active' : '') }}>
                <a href="/admin/reports"><i class="fa fa-bar-chart"></i> <span>Reservation Report</span></a>
            </li>
